...
public class CursoRepositoryTest {
    ...
    void testConsultaDeCursosMinistradosPorUmProfessor() throws SQLException {
        ...
        Assertions.assertTrue(cursoRepository.consultaDeCursosMinistradosPorUmProfessor("Roberta"));
    }
    ...
    void testConsultaDeCursosSemAlunosMatriculados() throws SQLException {
        ...
        Assertions.assertTrue(cursoRepository.consultaDeCursosSemAlunosMatriculados());
    }
}